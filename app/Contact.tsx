...
const Contact = () => {
  ...
  return (
    <div id="contact" className="relative isolate bg-cream px-6 py-24 sm:py-32 lg:px-8 bg-black">
      <div
      ...
      <div className="mx-auto max-w-2xl text-center">
        ...
        <p className="mt-2 text-lg leading-8">
          Please fill out the short form below to contact Sydney Soloists.
        </p>
      </div>
            ...
            <div className="relative mt-2.5">
              <div className="absolute inset-y-0 left-0 flex items-center">
                ...
                <select
                  id="country"
                  name="country"
                  className="h-full appearance-none rounded-md border-0 bg-transparent bg-none py-0 pl-4 pr-9 text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm"
                >
                  <option>AUS</option>
                  {/* <option>CA</option>
                  <option>EU</option> */}
